...
<header class="w3-display-container w3-content" style="max-width:1500px;">
  <img class="w3-image" src="../images/hotel.jpg" alt="The Hotel" style="min-width:1000px" width="1500" height="600">
  <div class="w3-display-right w3-padding w3-col l6 m6">
    <div  class="w3-container " style="background-color:#D2691E">
      <h2>Reservation des chambres</h2>
    </div>
    <div class="w3-container w3-white w3-padding-16">
      <form action="../ReserverARoom" method="post">
        ...
        <div class="w3-row-padding" style="margin:8px -16px;">
          ...
          <div class="w3-half">
            <label><i class="fa fa-child"></i> mineurs</label>
        ...
        <button class="w3-button w3-dark-grey" type="submit">Verifier</button>
      </form>
    </div>
  </div>
</header>
